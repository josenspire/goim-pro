...
func init() {
	proto.RegisterType((*Req)(nil), "hellogrpc.Req")
	proto.RegisterType((*Res)(nil), "hellogrpc.Res")
}
...
var fileDescriptor_94272a0853831a50 = []byte{
	...
	0xc9, 0x73, 0x31, 0x07, 0xa5, 0x16, 0x0a, 0x49, 0x70, 0xb1, 0x67, 0x15, 0xe7, 0xe7, 0x05, 0x97,
	0x14, 0x49, 0x30, 0x2a, 0x30, 0x6a, 0x70, 0x06, 0xc1, 0xb8, 0x4a, 0x8a, 0x20, 0x05, 0xc5, 0x42,
	0x52, 0x5c, 0x1c, 0x49, 0x89, 0xc9, 0xd9, 0x5e, 0xc5, 0xf9, 0x79, 0x50, 0x15, 0x70, 0xbe, 0x91,
	0x31, 0x17, 0x5b, 0x78, 0x62, 0x66, 0x49, 0x6a, 0x91, 0x90, 0x26, 0x17, 0xab, 0x4b, 0xbe, 0xaf,
	0x8b, 0xa9, 0x10, 0x9f, 0x1e, 0xc2, 0xce, 0xa0, 0xd4, 0x42, 0x29, 0x54, 0x7e, 0xb1, 0x12, 0x43,
	0x12, 0x1b, 0xd8, 0x29, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xd1, 0xe8, 0xf6, 0xa4, 0x9d,
	0x00, 0x00, 0x00,
}
...
func (c *waiterClient) DoMD5(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
	err := c.cc.Invoke(ctx, "/hellogrpc.Waiter/DoMD5", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Waiter_DoMD5_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hellogrpc.Waiter/DoMD5",
	}
