...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0x29, 0xa9, 0x84, 0x08, 0x14, 0x2b, 0xc9, 0x71, 0x71, 0x78, 0x80, 0x14, 0x04, 0xa5, 0x16, 0x0a,
	0x09, 0x71, 0xb1, 0xe4, 0x25, 0xe6, 0xa6, 0x4a, 0x30, 0x2a, 0x30, 0x6a, 0x70, 0x06, 0x81, 0xd9,
	0x4a, 0xaa, 0x5c, 0x9c, 0x50, 0xf9, 0xe2, 0x02, 0x21, 0x09, 0x2e, 0xf6, 0xdc, 0xd4, 0xe2, 0xe2,
	0xc4, 0x74, 0x98, 0x1a, 0x18, 0xd7, 0xc8, 0x9f, 0x8b, 0x2d, 0x3c, 0x31, 0xb3, 0x24, 0xb5, 0x48,
	0xc8, 0x95, 0x8b, 0x23, 0x38, 0xb1, 0x12, 0xac, 0x47, 0x48, 0x4a, 0x0f, 0xdd, 0x3e, 0x3d, 0x98,
	0x65, 0x52, 0xd2, 0x38, 0xe5, 0x8a, 0x0b, 0x94, 0x18, 0x92, 0xd8, 0xc0, 0x62, 0xc6, 0x80, 0x00,
	0x00, 0x00, 0xff, 0xff, 0x17, 0xfa, 0xaf, 0x36, 0xbf, 0x00, 0x00, 0x00,
}
...
func (c *waiterClient) SayHello(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloResp, error) {
	out := new(HelloResp)
...
func (*UnimplementedWaiterServer) SayHello(ctx context.Context, req *HelloReq) (*HelloResp, error) {
...
func _Waiter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WaiterServer).SayHello(ctx, req.(*HelloReq))
	}
