...
func init() {
	proto.RegisterType((*Req)(nil), "protos.Req")
...
var fileDescriptor_94272a0853831a50 = []byte{
	...
	0xc9, 0x4f, 0x2f, 0x2a, 0x48, 0xd6, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x03, 0x53, 0xc5,
	0x4a, 0xf2, 0x5c, 0xcc, 0x41, 0xa9, 0x85, 0x42, 0x12, 0x5c, 0xec, 0x59, 0xc5, 0xf9, 0x79, 0xc1,
	0x25, 0x45, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x30, 0xae, 0x92, 0x22, 0x48, 0x41, 0xb1,
	0x90, 0x14, 0x17, 0x47, 0x52, 0x62, 0x72, 0xb6, 0x57, 0x71, 0x7e, 0x1e, 0x54, 0x05, 0x9c, 0x6f,
	0xa4, 0xcb, 0xc5, 0x16, 0x9e, 0x98, 0x59, 0x92, 0x5a, 0x24, 0xa4, 0xcc, 0xc5, 0xea, 0x92, 0xef,
	0xeb, 0x62, 0x2a, 0xc4, 0x0d, 0xb1, 0xa6, 0x58, 0x2f, 0x28, 0xb5, 0x50, 0x0a, 0x89, 0x53, 0xac,
	0xc4, 0x90, 0x04, 0xb1, 0xda, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x4d, 0x09, 0x0d, 0x18, 0x94,
	0x00, 0x00, 0x00,
}
...
func (c *waiterClient) DoMD5(ctx context.Context, in *Req, opts ...grpc.CallOption) (*Res, error) {
	out := new(Res)
	err := c.cc.Invoke(ctx, "/protos.Waiter/DoMD5", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Waiter_DoMD5_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/protos.Waiter/DoMD5",
	}
