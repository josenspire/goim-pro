...
var fileDescriptor_bedfbfc9b54e5600 = []byte{
	...
	0x62, 0xf5, 0xc9, 0x4f, 0xcf, 0xcc, 0x23, 0xdb, 0x04, 0xa3, 0x10, 0x2e, 0xae, 0x60, 0xdf, 0x60,
	0x98, 0xa3, 0xdc, 0xb8, 0x78, 0xfd, 0x93, 0x4a, 0x12, 0x33, 0xf3, 0x82, 0x7d, 0x83, 0x9d, 0xf3,
	0x53, 0x52, 0x85, 0x24, 0x30, 0x35, 0x07, 0xfb, 0x06, 0x83, 0x8c, 0x95, 0xc4, 0x21, 0x03, 0x32,
	0xd5, 0x89, 0x29, 0x80, 0x31, 0x89, 0x0d, 0x2c, 0x6a, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x65,
	0xf4, 0x79, 0xcb, 0x25, 0x01, 0x00, 0x00,
}
...
type SMSServiceClient interface {
	ObtainSMSCode(ctx context.Context, in *SMSReq, opts ...grpc.CallOption) (*SMSResp, error)
}
...
func (c *sMSServiceClient) ObtainSMSCode(ctx context.Context, in *SMSReq, opts ...grpc.CallOption) (*SMSResp, error) {
	out := new(SMSResp)
...
type SMSServiceServer interface {
	ObtainSMSCode(context.Context, *SMSReq) (*SMSResp, error)
}
...
func (*UnimplementedSMSServiceServer) ObtainSMSCode(ctx context.Context, req *SMSReq) (*SMSResp, error) {
...
func _SMSService_ObtainSMSCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SMSServiceServer).ObtainSMSCode(ctx, req.(*SMSReq))
	}
	return interceptor(ctx, in, info, handler)
}
